# -*- coding: utf-8 -*-
"""
Created on Thu Mar 11 03:25:36 2021
...
def playGame(wordList):
    ...
    n=HAND_SIZE
    while True:
        ui=input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
        if ui == 'n':
            hand=dealHand(n)
